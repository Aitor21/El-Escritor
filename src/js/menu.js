(function() {
  ...
  Menu.prototype = {
    ...
    create: function () {
      ...
      //this.add.sprite(0, 0, 'titulo');


    this.text = this.add.text(this.world.centerX, this.world.centerY, "- El Escritor -");
    ...
    this.textReflect = this.add.text(this.world.centerX, this.world.centerY + 50, "- El Escritor -");
